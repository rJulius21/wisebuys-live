...
function site_files() {
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'wordpress-boilerplate.local')){
    ...
    wp_enqueue_script('main-site-js', get_theme_file_uri('/bundled-assets/scripts.bdd6be974eb6aea6643e.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.bdd6be974eb6aea6643e.css'));
  }
}
...
function ignoreCertainFiles($exclude_filters) {
  $exclude_filters[] = 'themes/wisebuys-splash/node_modules';
